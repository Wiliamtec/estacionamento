package com.estacionamento_api.entity;
...
public class ClienteVaga {
    ...
    @Column(name = "valor",columnDefinition = "decimal(7,2)") // a coluna ira conter no maximo  7 digitos com sua casas decimais
    private BigDecimal valor;

    @Column(name = "desconto",columnDefinition = "decimal(7,2)")
    private BigDecimal desconto;

    @ManyToOne //Mapeamento não Bidirecional
